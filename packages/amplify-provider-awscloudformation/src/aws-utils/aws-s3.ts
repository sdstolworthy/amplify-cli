...
import ora from 'ora';
import { ListObjectVersionsOutput, ListObjectVersionsRequest, ObjectIdentifier, GetObjectOutput } from 'aws-sdk/clients/s3';
...
export class S3 {
   ...
   */
  async getFile(s3Params: $TSAny, envName?: string): Promise<GetObjectOutput['Body']> {
